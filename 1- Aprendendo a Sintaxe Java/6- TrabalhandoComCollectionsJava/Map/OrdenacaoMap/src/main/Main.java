...
public class Main {
	...
	public static void main(String[] args) {
		...
		Map<String, Livro> meusLivros = new HashMap<>() {
			{
				put(" Hawking, Sthepen", new Livro("Uma breve história do tempo", 286));
				put(" Dunigg, Charles", new Livro("O poder do hábito", 406));
				put(" Harari, Yuval Noah", new Livro("21 Lições para o seculo 21", 150));
			}
		};
