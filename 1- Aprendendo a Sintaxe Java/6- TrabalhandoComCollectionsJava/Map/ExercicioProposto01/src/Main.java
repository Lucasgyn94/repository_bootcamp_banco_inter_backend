...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Estado = %s - População = %d", estadoMenorPopulacao, Collections.min(pop));
		
		System.out.println("\n=== ESTADO MAIOR POPULAÇÃO ===");
		System.out.printf("Estado = %s - População = %d", estadoMaiorPopulacao, Collections.max(pop));
		...
		// Media da população
		System.out.println("\n === MÉDIA DA POPULAÇÃO ===");
		System.out.println("Média = " + soma / populacaoEstadosNE.size());
		
		// Remova os estados com a população menor que 4.000.000:
		System.out.println("\n=== REMOÇÃO ESTADO POPULAÇÃO MENOR 4.000.000");
		...
		System.out.println("Dicionário apagado com sucesso!");
		
		System.out.println("Verificando se dicionário foi apagado!");
		if (populacaoEstadosNE.isEmpty()) {
			System.out.println("Verificação concluída, dicionário apagado com sucesso!");
		}else {
			System.out.println("Seu dicionário não foi apagado");
		}
